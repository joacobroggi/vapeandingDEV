  ...
  return (
   <Router>
    <Routes>
      ...
      <Route path="/carrito" element={usuario ? <Carrito /> : <Login/>}></Route>
      ...
      <Route path="/checkout" element={usuario ? <Comprar /> : <Login/>}></Route>
      <Route path="/checkout/pago" element={usuario? <Pago /> : <Login/>}></Route>
      <Route path="/pedidos" element={usuario? <Pedidos /> : <Login/>}></Route>

      <Route path="/login" element={usuario ? <Navigate to='/' /> : <Login />}></Route>

      <Route path="/registro" element={usuario ? <Navigate to='/' /> : <Registro />}></Route>
